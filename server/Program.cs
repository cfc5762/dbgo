...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //temp endpoint
            IPEndPoint localEndPoint = new IPEndPoint(new IPAddress(new byte[] { 127, 0, 0, 1 }), 57735);
                ...
                try
                {
                    ...
                    if (gamerQueue.Keys.Count >= 2)
                    {
                       ...
                       sendToGamer0.enemyID = "Player 2";
                        ...
                        Console.WriteLine(sendToGamer0.ip[0] + "." + sendToGamer0.ip[1] + "." + sendToGamer0.ip[2] + "." + sendToGamer0.ip[3] + ":" + sendToGamer0.port);
                       ...
                       sendToGamer1.enemyID = "Player 1";
                        ...
                        Console.WriteLine(sendToGamer1.ip[0] + "." + sendToGamer1.ip[1] + "." + sendToGamer1.ip[2] + "." + sendToGamer1.ip[3] + ":" + sendToGamer1.port);
